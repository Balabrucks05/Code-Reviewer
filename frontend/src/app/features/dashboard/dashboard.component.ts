    ...
    <div class="dashboard">
            ...
            <div class="security-score-card glass-premium scale-in">
              <div class="score-ring">
                <svg width="100" height="100" viewBox="0 0 100 100">
                  ...
                  <circle cx="50" cy="50" r="45" fill="none" stroke="rgba(255,255,255,0.08)" stroke-width="5"></circle>
                  <circle cx="50" cy="50" r="45" fill="none" stroke="url(#scoreGradient)" stroke-width="5"
      ...
      <section class="process-section" #featuresSection>
        <div class="section-header">
           <h2 class="section-title text-balance" #featuresTitle>Enterprise-Grade <span class="gradient-text-animated">Security Pipeline</span></h2>
              ...
              <div class="sample-card glass-premium glow-border" (click)="selectSample(sample)">
                 ...
                 <div class="code-preview sample-preview-window">
                   ...
                   <div class="code-content-wrapper p-3" style="position: relative;">
                     <pre class="code-content sample-code"><code>contract {{ toContractName(sample.name) }} {{ '{' }}
...
export class DashboardComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  private initGsapAnimations() {
    ...
    // ─── Features Section: heading reveal ───
  ...
  private loadSamples() {
    this.analysisService.getSampleContracts().subscribe({
      ...
      error: () => {
        ...
        this.samples.set([
          { id: '1', name: 'Reentrancy Vulnerable', filename: 'Vulnerable.sol', content: '...', description: 'Classic reentrancy attack vector', difficulty: 'Easy' },
          { id: '2', name: 'Missing Access Control', filename: 'NoAccessControl.sol', content: '...', description: 'Missing ownership validation', difficulty: 'Hard' },
          { id: '3', name: 'Unoptimized Contract', filename: 'Unoptimized.sol', content: '...', description: 'Inefficient storage patterns', difficulty: 'Medium' },
          { id: '4', name: 'Well-Written Contract', filename: 'WellWritten.sol', content: '...', description: 'Clean proxy storage layout', difficulty: 'Easy' }
        ]);
      }
    });
  }
  ...
  toContractName(name: string): string {
